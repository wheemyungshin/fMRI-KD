...
def main():
    ...
    save_file = "results/GenericObjectDecoding/analysis_FeaturePrediction.py-Subject1-V4-cnn5.pkl"
    with open(save_file, 'rb') as f:
        data = pickle.load(f)
        print('true_feature:', data['true_feature'])
        print('predicted_feature:', data['predicted_feature'])
        print('test_label:', data['true_feature'])
        print('test_label_set:', data['predicted_feature'])
        print('true_feature_averaged:', data['true_feature_averaged'])
        print('predicted_feature_averaged:', data['predicted_feature_averaged'])
        print('category_label_set:', data['category_label_set'])
        print('category_feature_averaged:', data['category_feature_averaged'])
