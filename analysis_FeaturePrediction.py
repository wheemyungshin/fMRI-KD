...
def main():
    ...
    for sbj, roi, feat in product(subjects, rois, features):
        ...
        y_sorted, _ = get_refdata(y, y_label, labels)  # Image features corresponding to brain data
        print("y_sorted: ", y_sorted)
        print("y_sorted: ", y_sorted.shape) #(3450, 1000)
        ...
        i_test = i_test_pt + i_test_im # 1750 + 500 (50*35 + 50*10)
        ...
        print(i_train_true)
        print(i_train_true.shape) #(1200, )
        print(i_test_pt_true)
        print(i_test_pt_true.shape) #(1750, )
        print(ind_cat_other_true)
        print(ind_cat_other_true.shape) #(15322, )

        y_train = y_sorted[i_train, :]
        y_test = y_sorted[i_test, :]

        print("x_train: ", x_train)
        print(x_train.shape) #(1200, 860)
        print("x_test: ", x_test)
        print(x_test.shape) #(2250, 860)
        print("y_train: ", y_train)
        print(y_train.shape) #(1200, 1000)
        print("y_test: ", y_test)
        print(y_test.shape) #(2250, 1000)
        ...
        print("true_y_pt: ", true_y_pt)
        print("true_y_pt: ", true_y_pt.shape) #(1750, 1000)
        ...
        print("test_label_im: ", test_label_im)
        print("test_label_im: ", test_label_im.shape) #(500, )
        ...
        print("pred_y_pt_av: ", pred_y_pt_av)
        print("pred_y_pt_av: ", pred_y_pt_av.shape) #(50, 1000)
        print("true_y_pt_av: ", true_y_pt_av)
        print("true_y_pt_av: ", true_y_pt_av.shape) #(50, 1000)
        print("test_label_set_pt: ", test_label_set_pt)
        print("test_label_set_pt: ", test_label_set_pt.shape) #(50, )
        ...
        print(y_catlabels)
        print(y_catlabels.shape)
        print(ind_catave.shape)

        print("y[ind_catave, :]: ", y[ind_catave, :])# feature
        print("y[ind_catave, :]: ", y[ind_catave, :].shape) # (50, 1000)
        print("y_catlabels[ind_catave, :]: ", y_catlabels[ind_catave, :]) # test dataset labels
        print("y_catlabels[ind_catave, :]: ", y_catlabels[ind_catave, :].shape)  # (50, 1)
        print("catlabels_set_pt: ", catlabels_set_pt) # test dataset labels
        print("catlabels_set_pt: ", catlabels_set_pt.shape) # (50, )

        y_catave_pt, _ = get_refdata(y[ind_catave, :], y_catlabels[ind_catave, :], catlabels_set_pt)
        y_catave_im, _ = get_refdata(y[ind_catave, :], y_catlabels[ind_catave, :], catlabels_set_im)

        print("y_catave_pt: ", y_catave_pt)
        print("y_catave_pt: ", y_catave_pt.shape)
